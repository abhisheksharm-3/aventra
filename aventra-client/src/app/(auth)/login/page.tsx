 ...
 * Left: Decorative section with animated elements and brand messaging
 * Right: Authentication form with login options
 */
...
export const metadata: Metadata = {
  title: "Login | Aventra",
  description: "Sign in to your account to continue your journey with Aventra",
}
  ...
  return (
    <Layout>
      <div className="min-h-screen flex flex-col md:flex-row">
        ...
        <div className="hidden md:block md:w-1/2 relative bg-gradient-to-br from-primary/5 via-primary/10 to-background">
          <div className="absolute inset-0 overflow-hidden">
            {/* Animated shapes with reduced motion for better performance */}
            <div 
              className="absolute top-[10%] left-[15%] w-64 h-64 rounded-full bg-primary/20 animate-drift-slow"
              aria-hidden="true"
            />
            <div 
              className="absolute top-[40%] right-[10%] w-40 h-40 rounded-full bg-blue-500/10 animate-drift-medium"
              aria-hidden="true"
            />
            <div 
              className="absolute bottom-[15%] left-[30%] w-52 h-52 rounded-full bg-indigo-500/10 animate-drift-fast"
              aria-hidden="true"
            />
            
            {/* Gradient overlay */}
            <div 
              className="absolute inset-0 bg-gradient-to-br from-transparent to-background/90"
              aria-hidden="true"
            />
            ...
            <div 
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                         w-[80%] max-w-md p-8 md:p-10 rounded-2xl backdrop-blur-xl 
            ...
            >
              <div className="mb-6">
                ...
                <h2 className="font-serif text-3xl md:text-4xl font-medium text-primary/90 mb-4">Your Journey Awaits</h2>
              ...
              <div className="space-y-4">
                <FeatureItem text="Advanced analytics and visualization" />
                <FeatureItem text="Personalized recommendations" />
                <FeatureItem text="Secure cloud synchronization" />
              </div>
            </div>
          </div>
        </div>
...
/**
 * Feature item component used in the left panel feature list
 */
function FeatureItem({ text }: { text: string }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <p className="text-primary/80 text-sm">{text}</p>
    </div>
  )
}